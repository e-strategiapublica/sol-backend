...
let TutorialService = class TutorialService {
    constructor(_tutorialRepository) {
        this._tutorialRepository = _tutorialRepository;
    }
    async getByScreenLocationWithUserId(screenLocation) {
...
TutorialService = __decorate([
    ...
    __metadata("design:paramtypes", [tutorial_repository_1.TutorialRepository])
], TutorialService);
