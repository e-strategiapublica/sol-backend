...
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
], Notification.prototype, "from_user", void 0);
__decorate([
...
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
], Notification.prototype, "bid_id", void 0);
Notification = Notification_1 = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: Notification_1.name.toLowerCase() })
], Notification);
