...
export class AssociationRepository {
  constructor(
    ...
    private readonly _model: Model<AssociationModel>,
  ) {}
      ...
      { _id },
      {
        $set: {
          ...
          "legalRepresentative.nationality":
            dto.legalRepresentative.nationality,
          "legalRepresentative.maritalStatus":
            dto.legalRepresentative.maritalStatus,
          "legalRepresentative.cpf": dto.legalRepresentative.cpf,
          "legalRepresentative.rg": dto.legalRepresentative.rg,
          "legalRepresentative.document_origin":
            dto.legalRepresentative.document_origin,
          "legalRepresentative.validityData":
            dto.legalRepresentative.validityData,
          "legalRepresentative.address.zipCode":
            dto.legalRepresentative.address.zipCode,
          "legalRepresentative.address.publicPlace":
            dto.legalRepresentative.address.publicPlace,
          "legalRepresentative.address.neighborhood":
            dto.legalRepresentative.address.neighborhood,
          "legalRepresentative.address.city":
            dto.legalRepresentative.address.city,
          "legalRepresentative.address.state":
            dto.legalRepresentative.address.state,
          "legalRepresentative.address.latitude":
            dto.legalRepresentative.address.latitude,
          "legalRepresentative.address.longitude":
            dto.legalRepresentative.address.longitude,
          "legalRepresentative.address.complement":
            dto.legalRepresentative.address.complement,
          "legalRepresentative.address.referencePoint":
            dto.legalRepresentative.address.referencePoint,
          "legalRepresentative.address.number":
            dto.legalRepresentative.address.number ?? "S/N",
        },
      },
    );
  }
  ...
  async deleteById(_id: string) {
    return await this._model.findOneAndUpdate(
      { _id },
      { $set: { status: AssociationStatusEnum.inactive } },
    );
  }
