...
export class ProposalController {
  ...
  @ApiBearerAuth()
  async register(@Body() dto: ProposalRegisterDto, @Req() request) {
    try {
  ...
  @ApiBearerAuth()
  async listProposalByBid(@Param("_id") _id: string) {
    try {
  ...
  @ApiBearerAuth()
  async getProposalAcceptedBid(@Param("_id") _id: string) {
    try {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  async verifyProposalByUser(@Req() request, @Param("_id") _id: string) {
    try {
      const payload: JwtPayload = request.user;

      const response = await this.proposalService.getByUserInBid(
        payload.userId,
        _id,
      );
  ...
  async updateAcceptfromSupplier(
    ...
    try {
      const response = await this.proposalService.updateAcceptfromSupplier(
        _id,
        dto,
      );
  ...
  async updateAcceptfromAssosiation(
    ...
    try {
      const response = await this.proposalService.updateAcceptAssociation(
        _id,
        dto,
      );
  ...
  async updateAcceptReviewer(
    ...
    try {
      const response = await this.proposalService.updateAcceptReviewer(
        _id,
        dto,
        request.user.userId,
      );
  ...
  async refused(
    ...
    try {
      ...
      const response = await this.proposalService.refusedProposal(
        _id,
        payload.userId,
        dto,
      );
  ...
  async accept(
    ...
    try {
      ...
      const response = await this.proposalService.acceptProposal(
        _id,
        payload.userId,
        dto,
      );
